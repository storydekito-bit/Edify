...
const demoAssetsSource = path.join(dist, 'demo-assets');
const demoAssetsTarget = path.join(root, 'demo-assets');
await rm(demoAssetsTarget, { recursive: true, force: true });
await cp(demoAssetsSource, demoAssetsTarget, { recursive: true });
